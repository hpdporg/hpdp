...
public class SummaryReportTest2 {
/*
...
/*        trans.exposureLocation(Trans.ExposureLocation.HTML_FILE);
        ...
        header2.letters = "Header 2: " + runDate;
     ...
     //   Region summaryTable1Region = new Region();
        ...
        compositeTable.table.newRow("Val");
        compositeTable.table.newRow("Val2");
        compositeTable.table.newRow("Val3");
        compositeTable.table.newRow("Val4");
        ...
        contributions.add(new String[]{"PASS"});
